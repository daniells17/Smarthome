...
<body>
	...
	<td><a href="menu.php" target="iframe_a"><img src="../images/icon/return64.png" alt="Home" longdesc="menu.php" height="40" width="40"/></a></td>
	</table>
<?php
	include "../administrator/koneksi.php";
	$kolom=3; 
	$query = "SELECT * FROM sub_menu where favorit='favorit'";
	$sql = mysqli_query($connect, $query);
	echo "<table width='100%' border='0' cellpadding='0' cellspacing='1' align='center' valign='char'>";
	...
	echo "</tr></table>";
?>
<div id="toast"><div id="img">Ok</div><div id="desc">A notification succes..</div></div>
</body>
</html>
